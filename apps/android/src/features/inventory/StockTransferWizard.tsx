        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 640 }}>
                ...
                {step === 'warehouses' && (
                    ...
                    >
                        <WarehouseSelector
                            ...
                            onChange={(id) => setForm({ ...form, fromWarehouseId: id })}
                        ...
                        <WarehouseSelector
                            ...
                            onChange={(id) => setForm({ ...form, toWarehouseId: id })}
                            label="To Warehouse"
                ...
                {step === 'confirm' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
                        <p>
                            From: {form.fromWarehouseId} → To: {form.toWarehouseId}
                        </p>
                        <p>Lines: {form.lines.length}</p>
                        {transferId && (
                            <p style={{ color: 'var(--color-success)' }}>Transfer created: {transferId}</p>
                        )}
                        <div style={{ display: 'flex', gap: 'var(--space-2)', justifyContent: 'flex-end' }}>
                            <button
                                type="button"
