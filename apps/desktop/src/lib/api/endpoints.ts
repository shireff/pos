export enum ApiEndpoints {
  ...
  PlatformAdminMfaSetup = '/api/platform-admin/auth/mfa/setup',
  PlatformAdminMfaSetupVerify = '/api/platform-admin/auth/mfa/setup/verify',
  ...
  StockTransferById = '/api/v1/stock/transfers/:id',
  ...
  WarehouseById = '/api/v1/warehouses/:id',
